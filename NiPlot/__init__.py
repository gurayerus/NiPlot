...
Use of this source code is governed by license located in license file: https://github.com/CBICA/NiPlot/blob/main/LICENSE
"""

from PyQt5 import QtCore, QtGui, QtWidgets
import argparse
import os, sys
from NiPlot.mainwindow import MainWindow
from NiPlot.NiPlotCmdApp import NiPlotCmdApp

def main():
    parser = argparse.ArgumentParser(description='NiPlot Data Visualization and Preparation')
    ...
    if(noGUI):
        ...
        # Set the style sheet
        styleFile = os.path.join(os.path.dirname(__file__), 'NiPlot_Stylesheet.qss')
